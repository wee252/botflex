...
tagadd = {
    ...
    "b": "บัญชีนี้ถูกป้องกันด้วย self bot by. ★pimcha botline★ ระบบได้บล็อคบัญชีคุณอัตโนมัติ >_<",
    "c":"auto like by. ★pimcha botline★",
        ...
        if op.type == 13:
            if maxgieMID in op.param3:
                ...
                if matched_list == []:
                    ...
                    maxgie.cancelGroupInvitation(op.param1, matched_list)
                        ...
                        try:
                            if settings["autolike"] == True:
                                ...
                                if settings["com"] == True:
                                    maxgie.createComment(purl[0], purl[1], sets["commat"])
                                ...
                                if settings["autolike"] == True:
                                    ...
                                    if settings["com"] == True:
                                        maxgie.createComment(msg._from, purl[1], tagadd["c"])
                                        wait['postId'].append(purl[1])
                                    else:pass
#=====================================================================
#=====================================================================
...
#            print("[ 25 ] SEND MESSAGE")
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "ประกาศ":
                    ...
                    sa+="\nตัวอย่าง >\\<"
                    sa+="\n- ประกาศ มอนิ่ง/lovepidchaya"
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": " ★pimcha botline★", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://ti/p/~lovepidchaya"}}
                    sendTemplate(to,data)
                ...
                if text.lower() == "ขาว":
                  if msg._from in admin:
                      ...
                      try:
                          tagadd["tag"] = text_
                          sa = "「 ตั้งคำแทค 」\nคือ : " + text_
                          data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "★pimcha botline★ ", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=ubd86e8c77559b1493f0ad64b1dba2d6c"}}
                          sendTemplate(to,data)
                      except:
...
"type": "uri",
"label": "ติดต่อเชล",
"uri": "https://line.me/ti/p/~lovepidchaya",
}
},
{
"flex": 3,
                                        ...
                                        "contents": [
                                            {
                                                ...
                                                "contents": [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "action": {
                                                            "type": "uri",
                                                            "uri": "http://line.me/ti/p/~lovepidchaya"
                                                        }
                                                    },
                                                    {
                                                        "type": "spacer",
                ...
                if text.lower() == "ออน" or text.lower() == "runtime":
                    ...
                    data = {
                        ...
                        "sentBy": {
                             "label": "รีบอทสำเร็จ...",
                             "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),
                             "linkUrl": "line://ti/p/~lovepidchaya"
                        }
                    }
                    sendTemplate(to, data)
...
#=====================================================================                
                ...
                elif text.lower() == 'speed':start = time.time();maxgie.sendMessage("ubd86e8c77559b1493f0ad64b1dba2d6c", "🌟★pimcha botline★🌟");elapsed_time = time.time() - start;duc1(to, "Speed : %s second"%str(round(elapsed_time,4)))
...
#=====================================================================                                       
                    ...
                    elapsed_time = time.time() - start
                    duc1(to, "ลบรันเสร็จแล้วขอรับ")
                    duc1(to, "ระยะเวลาที่ใช้: %sวินาที" % (elapsed_time))
...
#==============================================================================#
                 ...
                 #   profile = "https://profile.line-scdn.net/" + str(pp)
                  ...
                  #  
                    maxgie.unsendMessage(msg_id)
                    duc1(to, "{ Group ID }\n" + gid.id)
                    maxgie.sendMessage(to, maxgie.getGroup(to).name, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+maxgie.getGroup(to).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~', 'type': 'mt', 'subText': "★pimcha botline★", 'a-installUrl': 'https://line.me/ti/p/~', 'a-installUrl': ' https://line.me/ti/p/~', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~', 'i-linkUri': 'https://line.me/ti/p/~', 'id': 'mt000000000a6b79f9', 'text': '★pimcha botline★', 'linkUri': 'https://line.me/ti/p/~'}, contentType=19)
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.contentType == 0:
                if text is None:
                    return
                if text.lower() == ".":
                    duc1(to, "🌟Self Bot★pimcha botline★🌟") 
#========================================================================
