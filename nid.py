...
sets = {
    "l":True, 
      "c":True, 
      "cm":"AUTO LIKE FOR : ꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ",  
    "winvite": False,
    "wblacklist": False,
    "tagsticker": False,
    "Sticker": False,
...
tagadd = {
    ...
    "wctext": "หวัดดีๆๆๆๆ",
    "lv": "จะรีบไปใหน หว่า",
    "b": "บัญชีนี้ถูกป้องกันด้วย\n AUTO BLOCK ꧁ℓℓபחҨีҨюีℓℓのՏี่꧂  \nระบบได้บล็อคบัญชีคุณอัตโนมัติ >_<",
    "c":"AUTO LIKE FOR ꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ",
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "ประกาศ":
                    ...
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": " ꧁ℓℓபחҨีҨюีℓℓのՏี่꧂  ", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=uc00bb54b97ebb34309eaf67e17a6f50b"}}
                    sendTemplate(to,data)
                                    ...
                                    "header": {
                                        ...
                                        #        "size": "md"
                                            ...
                                            },
                                            {
                                                 ...
                                                 "action":{
                                                     "type":"uri",
                                                     "label":"꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ",
                                                     "uri":"line://nv/profilePopup/mid=uc00bb54b97ebb34309eaf67e17a6f50b"
                                                 },
                                            },
                                        ]
                                    },
...
{
"text": "  is bot line ꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ",
"size": "xs",
"margin": "none",
"color": "#00F5FF",
"wrap": True,
...
"uri": "line://nv/profilePopup/mid=uc00bb54b97ebb34309eaf67e17a6f50b",
                ...
                if text.lower() == "เรา":
                    contact = maxgie.getContact(sender)
                    sendTemplate(to,{"type":"flex","altText": "꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ","contents":{"type":"bubble","footer":{"type":"box","layout":"horizontal","contents":[{"color":"#333333","size":"xs","wrap":True,"action":{"type":"uri","uri":"https://sv1.picz.in.th/images/2019/05/19/wubKKl.gif"},"type":"text","text":"꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ","align":"center","weight":"bold"},{"type":"separator","color":"#FF3333"},{"color":"#FF3333","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://nv/profilePopup/mid=uc00bb54b97ebb34309eaf67e17a6f50b"},"type":"text","text":"ผู้สร้าง","align":"center","weight":"bold"}]},"styles":{"footer":{"backgroundColor":"#000000"},"body":{"backgroundColor":"#CCFFFF"}},"body":{"type":"box","contents":[{"type":"box","contents":[{"type":"separator","color":"#FF3333"},{"aspectMode":"cover","gravity":"bottom","aspectRatio":"1:1","size":"sm","type":"image","url":"https://sv1.picz.in.th/images/2019/05/19/wubKKl.gif"},{"type":"separator","color":"#FF3333"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://sv1.picz.in.th/images/2019/05/19/wubKKl.gif"},{"type":"separator","color":"#FF3333"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://img.live/images/2019/02/10/1549778907829.jpg"},{"type":"separator","color":"#FF3333"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://sv1.picz.in.th/images/2019/05/19/wubKKl.gif"},{"type":"separator","color":"#FF3333"}],"layout":"vertical","spacing":"none","flex":1},{"type":"separator","color":"#FF3333"},{"type":"box","contents":[{"type":"separator","color":"#FF3333"},{"color":"#FF3333","size":"md","wrap":True,"type":"text","text":" ꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ","weight":"bold"},{"type":"separator","color":"#FF3333"},{"color":"#FF3333","size":"md","wrap":True,"type":"text","text":"{}".format(contact.displayName),"weight":"bold"},{"type":"separator","color":"#FF3333"},{"color":"#FF3333","size":"xs","wrap":True,"type":"text","text":"Status Profile:","weight":"bold"},{"type":"text","text":"{}".format(contact.statusMessage),"size":"xxs","wrap":True,"color":"#FF3333"}],"layout":"vertical","flex":2}],"layout":"horizontal","spacing":"md"},"hero":{"aspectMode":"cover","margin":"xxl","aspectRatio":"1:1","size":"full","type":"image","url":"https://obs.line-scdn.net/{}".format(contact.pictureStatus)}}})            
                    ...
                    try:
                        ...
                        data = {
                            ...
                            "sentBy": {
                                 "label": "{}".format(maxgie.getContact(maxgieMID).displayName),
                                 "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),
                                 "linkUrl": "line://nv/profilePopup/mid=uc00bb54b97ebb34309eaf67e17a6f50b"
                            }
                        }
                        sendTemplate(to, data)
...
#=====================================================================                
                ...
                elif text.lower() == 'speed':start = time.time();maxgie.sendMessage("uc00bb54b97ebb34309eaf67e17a6f50b", "꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ");elapsed_time = time.time() - start;duc1(to, "Speed : %s second"%str(round(elapsed_time,4)))
...
#==============================================================================#
                        ...
                        maxgie.datamention(to,'꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ',nama)
...
#==============================================================================#
                 ...
                 #   profile = "https://profile.line-scdn.net/" + str(pp)
                  ...
                  #  
                    maxgie.unsendMessage(msg_id)
                    duc1(to, "{ Group ID }\n" + gid.id)
                    maxgie.sendMessage(to, maxgie.getGroup(to).name, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+maxgie.getGroup(to).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~', 'type': 'mt', 'subText': "꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ", 'a-installUrl': 'https://line.me/ti/p/~', 'a-installUrl': ' https://line.me/ti/p/~', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~', 'i-linkUri': 'https://line.me/ti/p/~', 'id': 'mt000000000a6b79f9', 'text': '꧁ℓℓபחҨีҨюีℓℓのՏี่꧂ ', 'linkUri': 'https://line.me/ti/p/~'}, contentType=19)
...
"type": "text"
                                          ...
                                          sendTemplate(to, data)                        
        if op.type == 26:
            print ("[  SELF BOT ꧁ℓℓபחҨีҨюีℓℓのՏี่꧂  ] ")
            msg = op.message
            text = str(msg.text)
            msg_id = msg.id
            receiver = msg.to
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if msg.text.lower() == "เชคapi":
                    ...
                    data = {"type": "text","text": "{}".format(lisk),"sentBy": {"label": "list API", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=uc00bb54b97ebb34309eaf67e17a6f50b"}}
                    sendTemplate(to,data)
#==============================================================================#
#==============================================================================#
        if op.type == 25:
