...
sets = {
    "l":True, 
      "c":True, 
      "cm":"auto like by : Mê£êrñz ßð†lïñê",  
    "winvite": False,
    "wblacklist": False,
    "tagsticker": False,
    "Sticker": False,
...
tagadd = {
    ...
    "wctext": "หวัดดีๆๆๆๆ",
    "lv": "จะรีบไปใหน หว่า",
    "b": "บัญชีนี้ถูกป้องกันด้วย\n autoblock Mê£êrñz ßð†lïñê \nระบบได้บล็อคบัญชีคุณอัตโนมัติ >_<",
    "c":"aito like for Mê£êrñz ßð†lïñê",
...
#            print("[ 25 ] SEND MESSAGE")
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "ประกาศ":
                    ...
                    sa+="\nตัวอย่าง >\\<"
                    sa+="\n- ประกาศ มอนิ่ง/wee252."
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": " Mê£êrñz ßð†lïñê", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=ue846139824ec13384cbb921b460323ac"}}
                    sendTemplate(to,data)
...
{
"text": "  is bot line Mê£êrñz ßð†lïñê",
"size": "xs",
"margin": "none",
"color": "#00F5FF",
"wrap": True,
...
#=====================================================================                
                ...
                elif text.lower() == 'speed':start = time.time();maxgie.sendMessage("ue846139824ec13384cbb921b460323ac", "Mê£êrñz ßð†lïñê");elapsed_time = time.time() - start;duc1(to, "Speed : %s second"%str(round(elapsed_time,4)))
...
#==============================================================================#
                        ...
                        maxgie.datamention(to,'Mê£êrñz ßð†lïñê',nama)
...
#==============================================================================#
                 ...
                 #   profile = "https://profile.line-scdn.net/" + str(pp)
                  ...
                  #  
                    maxgie.unsendMessage(msg_id)
                    duc1(to, "{ Group ID }\n" + gid.id)
                    maxgie.sendMessage(to, maxgie.getGroup(to).name, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+maxgie.getGroup(to).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~', 'type': 'mt', 'subText': "Mê£êrñz ßð†lïñê", 'a-installUrl': 'https://line.me/ti/p/~', 'a-installUrl': ' https://line.me/ti/p/~', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~', 'i-linkUri': 'https://line.me/ti/p/~', 'id': 'mt000000000a6b79f9', 'text': 'Mê£êrñz ßð†lïñê', 'linkUri': 'https://line.me/ti/p/~'}, contentType=19)
